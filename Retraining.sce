	...
	begin
      ...
      if j==last_word then
			...
			#RT
			 ...
			 info.append(string(ids[phraseID])+tab+string(blockID)+tab+string(reaction_time) + new_string);
			#end RT
...
information.append("id"+tab+"sem"+tab+"RT"+new_string);
